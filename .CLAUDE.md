...
7. Uncomment the `inst/tinytest/` line in `.Rbuildignore` to exclude tests from tarball
8. Run `devtools::check_win_release()` and wait for results
9. Run `R CMD check --as-cran` locally
10. Fix any issues / notes and update cran-comments.md as necessary
11. Submit to CRAN
