...
- Users can write plots to disk using the new `file` convenience argument. The
appropriate device type is automatically determined by the file extension, but
must be one of ".png", ".pdf", or ".svg". (#143 @grantmcdermott)
