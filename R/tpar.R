...
#'   \tab\tab\cr
#'   \tab\tab\cr
#'   `file.res` \tab\tab Numeric specifying the resolution (in dots per square inch) of any plot that is written to disk as a PNG file using the `tinyplot(..., file = "*.png")` argument. Defaults to 300.\cr
#'   \tab\tab\cr
#'   \tab\tab\cr
