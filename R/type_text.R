...
#'   Examples.
#' @param labeller A formatting function, convenience string, or named vector
#'   passed to [`tinylabel`] for formatting or relabelling the `labels`. Useful
#'   for ensuring that the text labels match the formatting of an axis, e.g.
#'   `labeller = "%"` to display the labels as percentages. Default is `NULL`,
#'   i.e. no formatting. See Examples.
