...
Customizing your plots further is straightforward. Here's a quick penultimate
example, where we change our font family, add some transparency to our colour
palette, and use Tufte-style floating axes with a background panel grid. 
...
we recommend the **basetheme** package.
