...
Our goal is to submit to CRAN by the end of September/October 2023, once we have
...
formula methods. Here's a simple example using a slightly modified version of
the `airquality` dataset that comes bundled with base R.
