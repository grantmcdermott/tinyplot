...
We provide a
"[Get Started](https://grantmcdermott.com/plot2/index.html#/vignettes/get_started)"
tutorial with numerous examples on the package homepage. But here are some
quickstart examples of the package in action.
