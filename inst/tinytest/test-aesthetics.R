...
f = function() tinyplot(Temp ~ Day | Month, data = aq, type = "b", pch = "by", lty = "by")
expect_snapshot_plot(f, label = "aesthetics_by")

# check non-point types don't generate points in legend accidentally
f = function() tinyplot(Temp ~ Day | Month, data = aq, type = "l", pch = "by", lty = "by")
expect_snapshot_plot(f, label = "aesthetics_by_type_l")

# no color version
f = function() tinyplot(Temp ~ Day | Month, data = aq, type = "b", pch = "by", lty = "by", col = "black")
expect_snapshot_plot(f, label = "aesthetics_by_nocol")

# inherit global par
f = function() {
  par(pch = 16)
  tinyplot(Temp ~ Day | Month, data = aq, type = "b", pch = "by", lty = "by")
}
