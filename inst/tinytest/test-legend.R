...
f = function() tinyplot(Temp ~ Day | Month, data = airquality, legend = FALSE)
expect_snapshot_plot(f, label = "legend_false")

f = function() tinyplot(Temp ~ Day | Month, data = airquality, legend = TRUE)
expect_snapshot_plot(f, label = "legend_true")

# position keyword examples 

f = function() with(airquality, tinyplot(x = Day, y = Temp, by = Month, legend = "bottom!"))
expect_snapshot_plot(f, label = "legend_keyword_default")

if ((getRversion() <= "4.3.2")) {
  f = function() with(airquality, tinyplot(x = density(Temp), by = Month, legend = "bottom!"))
  expect_snapshot_plot(f, label = "legend_keyword_density")
}

f = function() tinyplot(Temp ~ Day | Month, data = airquality, legend = "bottom!")
expect_snapshot_plot(f, label = "legend_keyword_formula")

# test other outer keywords

f = function() tinyplot(Temp ~ Day | Month, data = airquality, legend = "left!")
expect_snapshot_plot(f, label = "legend_keyword_outerleft")
f = function() tinyplot(Temp ~ Day | Month, data = airquality, legend = "bottom!")
expect_snapshot_plot(f, label = "legend_keyword_outerbottom")
f = function() tinyplot(Temp ~ Day | Month, data = airquality, legend = "top!")
expect_snapshot_plot(f, label = "legend_keyword_outertop")
f = function() tinyplot(Temp ~ Day | Month, data = airquality, legend = "topright!")
expect_snapshot_plot(f, label = "legend_keyword_outertopright")
f = function() tinyplot(Temp ~ Day | Month, data = airquality, legend = "bottomleft!")
...
f = function() {
  olmar = tpar("lmar")
  tpar(lmar = c(1.5, 0.5))
  tinyplot(Temp ~ Day | Month, data = airquality, legend = list("right!", bty = "o"))
...
f = function() {
  olmar = tpar("lmar")
  tpar(lmar = c(1.5, 0.5))
  tinyplot(Temp ~ Day | Month, data = airquality, legend = list("left!", bty = "o"))
  box("figure", lty = 2, col = "blue")
  tpar(lmar = olmar)
}
...
f = function() {
  olmar = tpar("lmar")
  tpar(lmar = c(1.5, 0.5))
  tinyplot(Temp ~ Day | Month, data = airquality, legend = list("bottom!", bty = "o"))
  box("figure", lty = 2, col = "blue")
  tpar(lmar = olmar)
}
...
f = function() {
  olmar = tpar("lmar")
  tpar(lmar = c(1.5, 0.5))
  tinyplot(Temp ~ Day | Month, data = airquality, legend = list("top!", bty = "o"))
  box("figure", lty = 2, col = "blue")
  tpar(lmar = olmar)
}
