...
limited convenience features pioneered by newer (`grid`-based) visualization
packages like `ggplot2` and `lattice`, e.g., grouped plots with automatic
legends and/or facets, advanced visualization types, and easy customization via
ready-made themes.
...
visualization packages. The package is available from CRAN
