...
To change the look of your plots, you can call the `tinytheme()` function. This will modify several graphical settings at once to match one of several pre-defined styles. The [Themes vignette](themes.qmd) provides a more detailed overview of this feature. Here, we apply the "ipsum" theme to a simple plot.
