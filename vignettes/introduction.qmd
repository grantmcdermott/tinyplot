...
types that can be a bit tedious to code up manually. You can see the full list
of supported plot types by checking the
[`?tinyplot`](https://grantmcdermott.com/tinyplot/man/tinyplot.html#arguments)
documentation, or by taking a look at the dedicated [Plot Types](types.qmd)
vignette on this website.
