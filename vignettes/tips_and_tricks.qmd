...
Please feel free to suggest or add more tips via our [GitHub repo](https://github.com/grantmcdermott/tinyplot/issues).
...
P.S. Another option for long axis labels is to wrap them at a designated character length. See the final example in the [`tinylabel`](https://grantmcdermott.com/tinyplot/man/tinylabel.html) documentation for an example.
